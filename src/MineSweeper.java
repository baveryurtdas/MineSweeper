...
public class MineSweeper {
    ...
    public void run() {
        ...
        mineNumber = (row * column) / 4; // Mayın sayısını hesaplama (oyun sahasının çeyreği kadar)

        // Oyun sahaları için iki matrisi başlatma

        map = new String[row][column]; // Mayınların saklandığı harita
        frame = new String[row][column]; // Oyuncunun gördüğü harita

        // Matrisleri "-" ile doldurma
    ...
    // Mayınların olduğu haritayı yazdırma
    ...
    // Oyuncunun gördüğü haritayı yazdır
    ...
    //oyuncunun kazanıp kazanmadığını kontrol etme
    boolean checkWin() {
        int emptyCell = 0;
        int minedCell = 0;
